#import "KustasoftWebBrowserPlugin.h"
...
@interface KustasoftWebBrowserPlugin() <FlutterStreamHandler>
@end
@implementation KustasoftWebBrowserPlugin {
  FlutterEventSink _eventSink;
  SFSafariViewController* _currentController;
}

+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  NSString* NS = @"kustasoft_web_browser";
  
  FlutterMethodChannel* channel = [FlutterMethodChannel
      methodChannelWithName:NS
            binaryMessenger:[registrar messenger]];
  KustasoftWebBrowserPlugin* instance = [[KustasoftWebBrowserPlugin alloc] init];
